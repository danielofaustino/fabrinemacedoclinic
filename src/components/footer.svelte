  ...
  <div tabindex="0" aria-label="footer" class="focus:outline-none mx-auto container flex flex-col items-center justify-center">
      ...
      <div class="text-black flex flex-col items-center f-f-l pt-3">
          ...
          <div class="my-6 text-base text-color f-f-l"> 
              <ul class="md:flex md:items-center">
                {#each links as link}
                  <li class="md:mr-6 cursor-pointer pt-4 lg:py-0 text-center"><a href={link.link} class="focus:outline-none   focus:underline hover:text-gray-500">{link.title}</a></li>
                  {/each}
                </ul>
          </div>
    ...
    <div class="w-7">
      <a href="https://wa.me/5511970433870"  target="__blank" alt="Whats App">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"  id="Layer_1" style="enable-background:new 0 0 56.693 56.693;" version="1.1" viewBox="0 0 56.7 56.7"  xml:space="preserve"><style type="text/css">
